...
* **Frameworks:**
  ...
  * Flask (Python based AI Microservice)
...
* Flask microservice(Python based)
...
EduConnect combines modern real-time technologies with intelligent AI services to enhance student communication and learning. With a scalable backend, strong authentication system, and clean UI interface, EduConnect will provide an advanced collaborative environment for academic success.
